...
public abstract class AListFragment<E> extends CustomFragmentItem implements
	 ...
	 */
	public AListFragment<E> setListShown(final boolean shown) {
		return setListShown(shown, true);
	}

	private AListFragment<E> setListShown(boolean shown, boolean animate) {
	...
	private AListFragment<E> fadeIn(final View view, final boolean animate) {
		if (view != null)
			if (animate)
	...
	private AListFragment<E> show(final View view) {
		ViewUtils.setGone(view, false);
		return this;
	}

	private AListFragment<E> hide(final View view) {
	 ...
	 * @return this fragment
	 */
	protected AListFragment<E> setEmptyText(final String message) {
		if (emptyView != null)
	 ...
	 * @return this fragment
	 */
	protected AListFragment<E> setEmptyText(final int resId) {
		if (emptyView != null)
	 ...
	 * @return this fragment
	 */
	protected AListFragment<E> notifyDataSetChanged() {
