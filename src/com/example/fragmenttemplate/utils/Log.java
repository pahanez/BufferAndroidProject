...
public final class Log {
	private static String APP_TAG = Application.class.getSimpleName();
	...
	static {
		...
		logger = Logger.getLogger(/*UbuntuOneFiles.TAG*/APP_TAG);
		logger.setLevel(Level.INFO);
		logger.setUseParentHandlers(false);
		
		apiLogger = Logger.getLogger(/*U1FileAPI.class.getName()*/APP_TAG);
	...
	public static boolean enableCollectingLogs() {
		try {
			File log = null; // = PreferencesActivity.getLogFile();
