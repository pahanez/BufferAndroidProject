...
public abstract class ItemListFrgmnt<E> extends CustomFragmentItem implements
		LoaderCallbacks<List<E>> { // TODO <String>
	...
	private void refresh(final Bundle args) {
		...
		getLoaderManager().restartLoader(0, args, this); // TODO
	}
	...
	protected void configureList(Activity activity, ListView listView) {
		// listView.setAdapter(createAdapter()); //TODO
	}
	 ...
	 * @return this fragment
	 */
	protected ItemListFrgmnt<E> notifyDataSetChanged() {
	...
	public void onLoadFinished(Loader<List<E>> loader, List<E> items) {
		...
		getSherlockActivity().setSupportProgressBarIndeterminateVisibility(
				false);
		Exception exception = getException(loader); // TODO
		if (exception != null) {
